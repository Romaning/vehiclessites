<li class="nav-main-item">
    ...
    <ul class="nav-main-submenu">
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{route('funcionario.index')}}">
                <span class="nav-main-link-name">Tabla Funcionarios</span>
            </a>
        </li>
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{route('funcionario.create')}}">
                <span class="nav-main-link-name">Form Registrar nuevo Funcionario</span>
            </a>
        </li>
    </ul>
</li>
